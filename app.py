...
class App(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        self.level_btn = ttk.Button(self.tab_datasets, text=tr("datasets_level_btn"), command=self._level_datasets)
        self.level_btn.grid(
            row=1,
            column=0,
            sticky="w",
        ...
        self.copy_btn = ttk.Button(self.tab_datasets, text=tr("copy_snapshot_btn"), command=self._copy_snapshot_to_dataset)
        self.copy_btn.grid(
            row=2,
            column=0,
            sticky="w",
        ...
        self.sync_btn = ttk.Button(self.tab_datasets, text=tr("datasets_sync_btn"), command=self._sync_datasets)
        self.sync_btn.grid(
            row=3,
            column=0,
            sticky="w",
        ...
        self.create_btn = ttk.Button(self.tab_datasets, text=tr("create_dataset_btn"), command=self._create_dataset)
        ...
        self.modify_btn = ttk.Button(self.tab_datasets, text=tr("modify_dataset_btn"), command=self._modify_dataset)
        self.modify_btn.grid(
            row=5,
            column=0,
            sticky="w",
            pady=(6, 0),
            ...
            if profile.password:
                if preserve_stdin_stream:
                    ...
                    return (
                        ...
                        f"sudo -S -p '' sh -lc {shlex.quote(inner)}"
                    )
                return (
                    f"printf '%s\\n' {shlex.quote(profile.password)} | "
